...
lein migrate-account -- -u dougbknight@gmail.com -e "Large Sample" -f "UBS Bank USA Deposit" -t "PMP LCC"
echo "Migrating PMP ACG..."
lein migrate-account -- -u dougbknight@gmail.com -e "Large Sample" -f "USA Deposit Account" -t "PMP ACG"
