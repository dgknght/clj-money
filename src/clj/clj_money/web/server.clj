...
(defroutes protected-routes
  ...
  ; Imports
  (model-route GET "/imports/new" imports/new-import)
  ...
  ; Single page apps
  (model-route GET "/apps" apps/index)
  (model-route GET "/apps/:id" apps/show))
...
(defroutes open-routes
  (model-route GET "/" pages/home)
  (model-route GET "/login" pages/login)
  (model-route GET "/signup" users/new-user)
  (model-route POST "/users" users/create-user)
  (model-route GET "/users/:token/password" users/new-password)
  (model-route POST "/users/:token/password" users/set-password))
